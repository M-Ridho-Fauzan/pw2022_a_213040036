    ...
    <div class="row mt-3 justify-content-center">
        <div class="col-8"> 
            <form action="" method="post" class="form-control" autocomplete="off" novalidate>
                    ...
                    <div class="mb-3">
                        <label for="gambar" class="form-label">Gambar (jika bertype link) :</label>
                        <input type="text" class="form-control" placeholder="fastekan di sini.." name="gambar" id="gambar" required>
                    </div>
                    <br><br>
                    <div class="mb-3">
