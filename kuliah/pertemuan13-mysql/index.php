...
// ORDER BY id DESC ini adalah mengurutkan data dari besar ke kecil
// ORDER BY id ASC adalah mengurutkan data dari kecil ke besar

// ketika tombol cari di tekan $mahasiswa akan di timpa
if( isset($_POST["cari"]) ){
...
<br><br>
<form class="d-flex" style="max-width:300px" action="" method="POST">
